...
Param(
# When extracting the First OU for a context in order to identify the context, the OU name is capitalized, unless the -DisableContextTitleCase switch is used
[switch] 
# When extracting OU Names, do not change the Title Case that this script uses by default
$DisableContextTitleCase,
# When extracting Group Names, do not change the Title Case that this script uses by default
[switch] 
$DisableGroupTitleCase
)
