...
try{
    ...
    Set-ExecutionPolicy Bypass -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}
...
try{
    ...
    Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope Process -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}
...
try{
    ...
    Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope CurrentUser -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
    }
...
try{
    ...
    Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope LocalMachine -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}
