...
try{
    powershell.exe -NonInteractive -Command Set-ExecutionPolicy Unrestricted -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}catch{
    Set-ExecutionPolicy Unrestricted -WarningAction SilentlyContinue -ErrorAction SilentlyContinue 2>&1 | out-null
}

try{
    powershell.exe -NonInteractive -Command Set-ExecutionPolicy Bypass -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}catch{
    $SUCCESS = Set-ExecutionPolicy -Scope LocalMachine Bypass -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}

try{
    powershell.exe -NonInteractive -Command Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope Process -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}catch{
    $SUCCESS = Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope Process -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}

try{
    powershell.exe -NonInteractive -Command Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope CurrentUser -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}catch{
    $SUCCESS = Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope CurrentUser -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
    }

try{
    powershell.exe -NonInteractive -Command Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope LocalMachine -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}catch{
    $SUCCESS = Set-ExecutionPolicy -ExecutionPolicy Unrestricted -Scope LocalMachine -ErrorAction SilentlyContinue -WarningAction SilentlyContinue 2>&1 | out-null
}
